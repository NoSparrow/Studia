...
class Program
{
    static void Main()
    {
        ...
        double a = Convert.ToDouble(Console.ReadLine()); //Poranie wartości od użytkownia i konwersja na typ danych double
    ...
    static string ObliczPierwiastki(double a, double b, double c)
    {
        ...
        {
            double x0 = -b / (2 * a);
            return $"Jeden pierwiastek: x0 = {x0:F3}"; // F3 - format liczby dla x0, F - zmiennoprzecinkowa, 3 - trzy miejsca po przecinku
        }
        else
        {
